...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="#2"><img src="{{url('/Base/')}}/assets/images/icon-3.png" alt=""> <em>Lampiran Presensi</em></a>
            </li>
            <li><a href="#3"><img src="{{url('/Base/')}}/assets/images/icon-4.png" alt=""> <em>Bantuan</em></a></li>
        </ul>
    </nav>
    ...
    <div class="slides">
        <div class="slide" id="1">
            ...
            <div class="content second-content" style="z-index: 1; position: absolute;">
                <div id='tabs'>
                    <ul style="border: 1px solid; padding: 7px; border-radius: 20px; background-color: #D4ECDD;">
                        <li style="width: 75px; height: 75px;"><a href='#tabs-1'><span class='fa fa-desktop' style="width: 75px; height: 75px;"></span></a></li>
                        <li style="width: 75px; height: 75px;"><a href='#tabs-2'><span class='fa fa-users' style="width: 75px; height: 75px;"></span></a></li>
                        <li style="width: 75px; height: 75px;"><a href='#tabs-3'><span class='fa fa-mobile' style="width: 75px; height: 75px;"></span></a></li>
                    </ul>
                ...
                <div id="image-slider">
                    <ul>
                        <li class="active-img" id="c_profile">
                            <div class="slide-caption" style="position: relative; float: left; margin-left: 18%; text-align: left;">
                                <h6 style="color: #000;">{{ Auth::user()->jabatan }}</h6>
                                <h2 style="color: #000;"><span style="font-size: 30px;">{{ Auth::user()->name }}</span><br>Gelar</h2>
                            </div>
                        </li>
                        <li id="c_masuk">
                            <div class="slide-caption" style="position: relative; float: left; margin-left: 18%; text-align: left;">
                                <div class="rounded embed-responsive embed-responsive-21by9">
                                    <iframe class="embed-responsive-item" src="{{url('/Base/')}}/clock.html" style="border: 1px solid; background: #000; height: 100px; width: 265px; border-radius: 20px;"></iframe>
                                </div>
                                <h6 style="color: #000;">Presensi Masuk</h6>
                                <h2 style="font-size: 25px; color: #000;">Presensi DI Buka
                        ...
                        <li id="c_keluar">
                            <div class="slide-caption">
                                ...
                                <h6 style="color: #000;">Presensi Keluar</h6>
                                <h2 style="font-size: 25px; color: #000;">Presensi DI Buka
                                    <br>{{$data['setting']['jam-absen-keluar-open']->value}}.00</h2>
                                    <!-- <a href="#" id="nas2" class="btn btn-primary btn-lg neka" onclick="fas()">Isi Daftar
                                    Keluar</a> -->
                                    <a href="{{url('/mas')}}" id="nas2" class="btn btn-primary btn-lg neka">Isi Daftar
                                    Keluar</a>
                            </div>
                        </li>
                    </ul>
                </div>
                <div id="thumbnail" style="margin-right: 56%; padding: 0;">
                    <ul>
                        <li class="active"><img id="ocuka" class="rounded" src="{{ Auth::user()->profile_photo_path }}"
                                alt="Earth" style="width: 50px; height: 75px; border: 1px solid;" /></li>
                        <li><img id="mosku" class="rounded domi" src="{{url('/Base/')}}/assets/images/Masuk.png"
                                alt="Meeting" style="width: 50px; height: 75px; border: 1px solid; background: #152D35;" /></li>
