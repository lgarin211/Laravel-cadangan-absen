...
<body>
    <div class="container mt-5 card">
        <div class="row text-center">
            <div class="col-sm-6">
                ...
                <form action="{{url('/req/sen2')}}" method="get" class="form-grup" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3 bt-2">
                    ...
                    <input type="hidden" id="masla" name="vas">
                    <input type="hidden" name="dar" value="das">
    ...
    <script>
        ...
        document.getElementById("masla").value=Bulan+'-'+Tanggal+'-'+Tahun
